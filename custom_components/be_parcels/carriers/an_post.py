"""An Post vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: An Post is met gratis, server-side middelen niet haalbaar
...
class AnPostCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "An Post is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/an_post.py."
        )
