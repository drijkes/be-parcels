"""Österreichische Post vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van Österreichische Post,
...
class AustrianPostCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Österreichische Post-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/austrian_post.py."
        )
