"""Chronopost vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: Chronopost is met gratis, server-side middelen niet haalbaar
...
class ChronopostCarrier(ParcelCarrier):
    slug = "chronopost"
    name = "Chronopost"
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Chronopost is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/chronopost.py."
        )
