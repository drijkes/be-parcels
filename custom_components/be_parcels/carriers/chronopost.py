"""Chronopost vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van Chronopost,
...
class ChronopostCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Chronopost-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/chronopost.py."
        )
