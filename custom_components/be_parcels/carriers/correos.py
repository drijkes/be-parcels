"""Correos vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: Correos is met gratis, server-side middelen niet haalbaar
...
class CorreosCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Correos is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/correos.py."
        )
