"""CTT vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: CTT is met gratis, server-side middelen niet haalbaar
...
class CttCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "CTT is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/ctt.py."
        )
