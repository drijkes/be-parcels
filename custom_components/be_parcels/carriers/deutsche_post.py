"""Deutsche Post vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van Deutsche Post,
...
class DeutschePostCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Deutsche Post-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/deutsche_post.py."
        )
