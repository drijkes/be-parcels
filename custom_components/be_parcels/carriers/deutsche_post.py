"""Deutsche Post vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: Deutsche Post is met gratis, server-side middelen niet haalbaar
...
class DeutschePostCarrier(ParcelCarrier):
    slug = "deutsche_post"
    name = "Deutsche Post"
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Deutsche Post is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/deutsche_post.py."
        )
