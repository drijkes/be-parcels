"""DHL vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van DHL,
...
class DhlCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "DHL-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/dhl.py."
        )
