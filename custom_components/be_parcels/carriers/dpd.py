            ...
            async with self._session.get(
                ...
                if resp.status == 403:
                    raise ParcelProviderError(
                        "DPD blokkeerde het verzoek (403) — vermoedelijk "
                        "Cloudflare-botbescherming. Zie caveat in dpd.py; dit kan "
                        "verder aangepaste headers of een andere aanpak vereisen."
                    )
                if resp.status != 200:
