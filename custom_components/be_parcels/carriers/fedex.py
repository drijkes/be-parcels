"""FedEx vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: FedEx is met gratis, server-side middelen niet haalbaar
...
class FedexCarrier(ParcelCarrier):
    slug = "fedex"
    name = "FedEx"
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "FedEx is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/fedex.py."
        )
