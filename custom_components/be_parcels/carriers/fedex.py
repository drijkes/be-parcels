"""FedEx vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van FedEx,
...
class FedexCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "FedEx-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/fedex.py."
        )
