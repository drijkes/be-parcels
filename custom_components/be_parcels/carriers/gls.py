"""GLS vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: GLS is met gratis, server-side middelen niet haalbaar
...
class GlsCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "GLS is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/gls.py."
        )
