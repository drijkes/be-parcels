"""InPost vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: InPost is met gratis, server-side middelen niet haalbaar
...
class InPostCarrier(ParcelCarrier):
    slug = "inpost"
    name = "InPost"
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "InPost is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/inpost.py."
        )
