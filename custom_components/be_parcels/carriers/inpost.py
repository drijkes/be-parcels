"""InPost vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van InPost,
...
class InPostCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "InPost-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/inpost.py."
        )
