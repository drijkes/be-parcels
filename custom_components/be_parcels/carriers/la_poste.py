"""La Poste / Colissimo vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: La Poste / Colissimo is met gratis, server-side middelen niet haalbaar
...
class LaPosteCarrier(ParcelCarrier):
    slug = "la_poste"
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "La Poste / Colissimo is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/la_poste.py."
        )
