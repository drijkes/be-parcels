"""La Poste / Colissimo vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van La Poste / Colissimo,
...
class LaPosteCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "La Poste / Colissimo-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/la_poste.py."
        )
