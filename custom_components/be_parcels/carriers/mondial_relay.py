"""Mondial Relay vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: Mondial Relay is met gratis, server-side middelen niet haalbaar
...
class MondialRelayCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Mondial Relay is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/mondial_relay.py."
        )
