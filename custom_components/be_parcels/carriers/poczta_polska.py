"""Poczta Polska vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: Poczta Polska is met gratis, server-side middelen niet haalbaar
...
class PocztaPolskaCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Poczta Polska is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/poczta_polska.py."
        )
