"""Poste Italiane vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: Poste Italiane is met gratis, server-side middelen niet haalbaar
...
class PosteItalianeCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Poste Italiane is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/poste_italiane.py."
        )
