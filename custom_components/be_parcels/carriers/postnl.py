"""PostNL vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van PostNL,
...
class PostNlCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "PostNL-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/postnl.py."
        )
