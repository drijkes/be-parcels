"""PostNord vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: PostNord is met gratis, server-side middelen niet haalbaar
...
class PostNordCarrier(ParcelCarrier):
    slug = "postnord"
    name = "PostNord"
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "PostNord is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/postnord.py."
        )
