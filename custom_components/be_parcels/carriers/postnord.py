"""PostNord vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van PostNord,
...
class PostNordCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "PostNord-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/postnord.py."
        )
