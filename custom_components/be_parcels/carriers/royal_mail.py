"""Royal Mail vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: Royal Mail is met gratis, server-side middelen niet haalbaar
...
class RoyalMailCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Royal Mail is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/royal_mail.py."
        )
