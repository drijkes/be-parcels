"""Swiss Post vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: Swiss Post is met gratis, server-side middelen niet haalbaar
...
class SwissPostCarrier(ParcelCarrier):
    slug = "swiss_post"
    name = "Swiss Post"
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Swiss Post is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/swiss_post.py."
        )
