"""Swiss Post vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van Swiss Post,
...
class SwissPostCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "Swiss Post-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/swiss_post.py."
        )
