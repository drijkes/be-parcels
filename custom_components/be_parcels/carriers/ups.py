"""UPS vervoerder-plugin — NIET HAALBAAR (gratis, zonder account).
...
CONCLUSIE: UPS is met gratis, server-side middelen niet haalbaar
...
class UpsCarrier(ParcelCarrier):
    slug = "ups"
    name = "UPS"
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "UPS is niet haalbaar gebleken zonder betaalde dienst — "
            "zie de uitleg bovenaan carriers/ups.py."
        )
