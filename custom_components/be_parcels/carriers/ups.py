"""UPS vervoerder-plugin — SKELET (nog niet geïmplementeerd).
...
devtools Network-tab op de eigen track&trace-pagina van UPS,
...
class UpsCarrier(ParcelCarrier):
    ...
    async def async_get_status(
        ...
        raise ParcelProviderError(
            "UPS-ondersteuning is nog niet geïmplementeerd — zie de "
            "instructies bovenaan carriers/ups.py."
        )
