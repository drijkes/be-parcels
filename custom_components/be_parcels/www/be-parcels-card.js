    ...
    this.shadowRoot.innerHTML = `
      ...
      <ha-card>
        ...
        <div class="field">
          ...
          <select id="carrier">
            <option value="bpost" ${this._carrier === "bpost" ? "selected" : ""}>bpost</option>
            <option value="dpd" ${this._carrier === "dpd" ? "selected" : ""}>DPD</option>
            <option value="gls" ${this._carrier === "gls" ? "selected" : ""}>GLS</option>
          </select>
        </div>
